...
@section('content')
    <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Commandes actives triées par heure de retrait pour la preparation et le comptoir.</p>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 align-top">
                                    ...
                                    @elseif($order->status === 'ready')
                                        <span class="inline-flex border border-green-400 px-2 py-1 text-xs font-medium text-green-700">Prete</span>
                                    @else
                                        <span class="inline-flex border border-blue-400 px-2 py-1 text-xs font-medium text-blue-700">Livree</span>
                                    @endif
                                </td>
